const Why = () => {
  return (
    <section class="bg-primary pattern">
        <div class="container px-6 py-8 mx-auto">
            <div className="flex justify-center my-4">
                <img className="w-auto h-7 md:h-14" src='./images/main_logo.png' alt="logo" />
            </div>
            <div class="grid grid-cols-1 gap-8 xl:gap-16 md:grid-cols-2 xl:grid-cols-3">
                <div class="flex flex-col items-center p-6 space-y-3 text-center bg-gray-100 rounded-xl">
                    <span class="inline-block p-3 text-primary_dark bg-primary rounded-full ">
